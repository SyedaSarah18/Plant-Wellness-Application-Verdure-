class Plant {
  ...
  static List<Plant> addedToMyPlants() {
    List<Plant> _myPlantsList = Plant.plantList;
    return _myPlantsList.where((element) => element.isMyPlant == true).toList();
  }
}
